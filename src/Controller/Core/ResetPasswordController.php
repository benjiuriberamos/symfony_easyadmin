...
class ResetPasswordController extends AbstractController
{
    ...
    public function change(Request $request, UserPasswordHasherInterface $userPasswordHasher, UserRepository $repository): RedirectResponse
    {
        ...
        if (!$userPasswordHasher->isPasswordValid($this->getUser(), $currentPassword)) {
            $this->addFlash('error', 'La contraseña ingresada no es correcta');
            return $this->redirect($request->headers->get('referer'));
        }
        ...
        try {
            $encodedPassword = $userPasswordHasher->hashPassword($this->getUser(), $newPassword);
            $repository->upgradePassword($this->getUser(), $encodedPassword);
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address($this->getParameter('mail_from_email'), $this->getParameter('mail_from_name')))
            ->to($user->getEmail())
